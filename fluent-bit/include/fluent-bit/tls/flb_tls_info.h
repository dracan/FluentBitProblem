 ...
 * "C:/Program Files (x86)/fluent-bit/etc/certs/rootcert.pem"
 * during the building process.
 */
#define FLB_DEFAULT_SEARCH_CA_BUNDLE "C:/Program Files (x86)/fluent-bit/etc/certs/rootcert.pem"
#define FLB_DEFAULT_CA_DIR "C:/Program Files (x86)/fluent-bit/etc/certs/"
